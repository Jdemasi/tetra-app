...
| `invoices` * | `id, company_id, project_id, invoice_number, invoice_date, description, bill_to, billed_amount, retainage_pct, paid_amount, terms_days, status, notes, pdf_url, created_at, deleted_at` |
...
### 2026-08-31 — CLAUDE.md regenerated
